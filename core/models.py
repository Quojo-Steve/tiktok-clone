...
#             raise ValueError('Staff must be assigned to true')    
        
#         if other_fields.get('is_superuser') is not True:
#             raise ValueError('Superuser must be assigned to true')  
...
#     img = models.ImageField(upload_to = 'profile_img', default ='cat.png')
